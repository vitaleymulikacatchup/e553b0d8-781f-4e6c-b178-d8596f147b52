...
export const metadata: Metadata = {
  title: "Brew & Bean - Premium Coffee Shop & Roastery",
  description: "Experience exceptional coffee at Brew & Bean. Premium beans, expert craftsmanship, and sustainable sourcing. Order online or visit our welcoming café.",
  keywords: ["coffee shop", "premium coffee", "espresso", "latte", "cold brew", "sustainable coffee", "artisan coffee", "coffee beans", "café"],
  openGraph: {
    title: "Brew & Bean - Premium Coffee Shop & Roastery",
    description: "Experience exceptional coffee at Brew & Bean. Premium beans, expert craftsmanship, and sustainable sourcing.",
    siteName: "Brew & Bean",
    type: "website",
    images: [
      {
